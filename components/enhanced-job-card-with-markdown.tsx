...
interface EnhancedJobCardWithMarkdownProps {
  job: JobCardData;
...
export function EnhancedJobCardWithMarkdown({ job, onApply, onView, className = "" }: EnhancedJobCardWithMarkdownProps) {
  ...
  return (
    <>
      ...
      {/* Full Job View Panel */}
      <Sheet open={showFullView} onOpenChange={setShowFullView}>
          ...
          <div className="space-y-6 mt-6">
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <MarkdownRenderer
                  content={job.fullDescription || job.description}
